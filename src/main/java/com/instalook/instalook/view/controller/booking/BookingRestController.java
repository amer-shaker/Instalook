...
public class BookingRestController {
    ...
    public Object cancelBooking(@RequestParam int bookingId) {
        ...
        if (isBookingDeleted) {
            Response responseBody = new Response(HttpStatus.OK, "Reservation Canceled Successfully");
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            return responseBody;
        } else {
            Response responseBody = new Response(HttpStatus.CONFLICT, "Failed to Canceled Reservation");
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            return responseBody;
        }
